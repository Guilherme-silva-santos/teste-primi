...
export const UploadInput: FC<UploadInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="w-100 h-50 lg:h-150 flex items-center justify-center bg-gray-800 border border-gray-700 rounded-xl cursor-pointer overflow-hidden hover:border-purple-500/60 transition-all duration-300"
    >
      {preview ? (
        <img
          src={preview}
